"""Excepciones del dominio ClinicFlow."""
...
class PacienteYaEnEspera(ClinicFlowError):
    """El paciente ya está inscrito en esta lista de espera."""
...
class DerivacionExpirada(ClinicFlowError):
    """La derivación ya no es válida; su plazo de vigencia venció."""


class DerivacionYaUsada(ClinicFlowError):
    """La derivación ya fue completada y no puede usarse nuevamente."""
